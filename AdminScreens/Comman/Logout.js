...
import { Profile_Style } from '../../Screens/Profile';
...
export default class Logout extends React.Component{
    ...
    UploadImage = async (PP) => {
        ...
        const UploadTask = storage.ref('Admin').child(filepath).put(blob);
    ...
    render(){
        ...
        return(
            <View style = {{flex : 1, backgroundColor : 'white'}}>
                ...
                />
                <View style = {{...Profile_Style.header,...{height : hp('20%')}}}>
                </View>
                    ...
                    <View>
                                ...
                                <TouchableOpacity activeOpacity = {0.5} onPress = {() => this._pickGalleryImage()}>
                                    <View style = {{flexDirection : 'row'}}>
                                        ...
                                        <View style= {{marginLeft : wp('3%'),marginTop : hp('1%')}}>
                                            <Text style = {{fontSize : hp('2.5%'),color : '#154293'}}>Edit Pic</Text>
                                        </View>
                                    </View>
                                </TouchableOpacity>
                            </Card>
                            ...
                            <Card style = {{...Profile_Style.buttoncon, ...{backgroundColor : '#154293',borderColor : 'black'}}}>
                                <TouchableOpacity activeOpacity = {0.5} onPress = {() => this.modalshow()}>
                                    <View style = {{flexDirection : 'row'}}>
                                        ...
                                        <View style= {{marginLeft : wp('3%'),marginTop : hp('1%')}}>
                                            <Text style = {{fontSize : hp('2.5%'),color : 'white'}}>Edit Profile</Text>
                                        </View>
                                    </View>
                                </TouchableOpacity>
                            </Card>
                        ...
                        >
                            <View style = {{backgroundColor : 'white',height : hp('50%'),borderRadius : wp('5%')}}>
                                <Text style = {{textAlign : 'center',fontSize : hp('2.5%'),marginTop : hp('2%'),fontWeight : 'bold'}}>Edit Profile</Text>

                                <Text style = {{marginTop : hp('4%'),fontSize : hp('2.5%'),marginLeft : wp('6%'),fontWeight : 'bold'}}>User name : </Text>
                                <View>
                                    <TextInput
                                ...
                                <Text style = {{marginTop : hp('2%'),fontSize : hp('2.5%'),marginLeft : wp('6%'),fontWeight : 'bold'}}>Email : </Text>
                                <View>
                                    <TextInput
