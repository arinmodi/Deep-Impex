export const PhtmlContent = (data) => {
    console.log(data);
        return `
        <!DOCTYPE html>
            <html lang="en">
            ...
            ` +
                data.map(element => 
                       ...
                       <body>
                        ...
                        <h3 style = "color : blue;">Grand Purchase : ${element.purchase} </h3>
                        <h3 style = "margin-top : 10;color : green;">Grand Debit : ${element.Debit} </h3>
                        <h3 style = "color : red;">Grand Credit : ${element.Credit} </h3>
                        <h3 style = "color : #30196B;">Pre.Bal : ${element.PreBal} </h3>
                        <h3 style = "color : blue;">Remaining : ${element.Rem} </h3>
